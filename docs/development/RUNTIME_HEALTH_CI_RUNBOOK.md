...
- workflow validates policy structure and referenced files via `arango-er runtime-quality-policy-validate --policy-file ci/runtime-quality/quality_gate_policy.json`
