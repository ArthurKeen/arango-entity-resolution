#!/usr/bin/env python3
"""
Unit Tests for EntityResolutionLogger

Comprehensive unit tests for EntityResolutionLogger service.
"""
...
from entity_resolution.services.logging import EntityResolutionLogger
from entity_resolution.utils.config import get_config
from entity_resolution.utils.logging import get_logger

class TestEntityResolutionLogger(unittest.TestCase):
    """Test cases for EntityResolutionLogger."""
    
    def setUp(self):
        """Set up test fixtures."""
        self.config = get_config()
        self.logger = get_logger(__name__)
        self.service = EntityResolutionLogger()
        
    def test_initialization(self):
        """Test service initialization."""
        self.assertIsNotNone(self.service)
        self.assertIsInstance(self.service, EntityResolutionLogger)
